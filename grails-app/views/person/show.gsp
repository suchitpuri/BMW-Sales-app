		...
		<div class="dialog">
			...
			<tbody>
				...
				<tr class="prop">
					...
					<td valign="top" class="value">${person.zone?.encodeAsHTML()}</td>
				</tr>
				<tr class="prop">
					<td valign="top" class="name">City:</td>
					<td valign="top" class="value">${person.city?.encodeAsHTML()}</td>
				</tr>
				<tr class="prop">
					<td valign="top" class="name">Dealer:</td>
					<td valign="top" class="value">${person.dealer?.encodeAsHTML()}</td>
				</tr>
